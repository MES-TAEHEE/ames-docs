...
internal sealed class RepoAndonStore : IAndonStore
{
    ...
    public void CallDepts(int andonId, string causeCode, IEnumerable<string> deptCodes, string calledBy)
        => PopServices.Andon.CallDepts(andonId, causeCode, deptCodes, calledBy);
    ...
    public void Resolve(int andonId, string? causeCode) => PopServices.Andon.Resolve(andonId, causeCode);
}
