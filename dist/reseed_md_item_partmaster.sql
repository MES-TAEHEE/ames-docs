...
-- + TAILGATE/DOOR TRIM 계열 137 품번 추가 (SEMS ACD0020/ACD0020L/ZCD1010/ACD0021 조인, 2026-09-02).
--   ItemType 은 ACD0020.ESTI_CLASS(1F7920=ASSY/1F7900=SUB/1F3100=ASSY/1F3000=MATERIAL) 기준.
SET NOCOUNT ON;
SET XACT_ABORT ON;
BEGIN TRAN;
...
INSERT INTO dbo.MD_Item (ItemNo, ItemName, ItemType, ItemCategory, CarType, DefaultUOM, SafetyStock, PGN, ALC, ActiveFlag, CreatedBy, CreatedTS) VALUES
  ('81720-PI000NNB',     N'TRIM ASSY-TAIL GATE UPR',                   'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q010',  'N00B',   1, 'admin', SYSDATETIME()),
  ('81720-PI000YGN',     N'TRIM ASSY-TAIL GATE UPR',                   'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q010',  'N00G',   1, 'admin', SYSDATETIME()),
  ('81720-TD000NNB',     N'TRIM ASSY-TAIL GATE UPR',                   'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q010',  'S00B',   1, 'admin', SYSDATETIME()),
  ('81720-TD000PNY',     N'TRIM ASSY-TAIL GATE UPR',                   'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q010',  'S00P',   1, 'admin', SYSDATETIME()),
  ('81730-PI000NNB',     N'TRIM ASSY-TAIL GATE SIDE, LH',              'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q012',  'N00B',   1, 'admin', SYSDATETIME()),
  ('81730-PI000YGN',     N'TRIM ASSY-TAIL GATE SIDE, LH',              'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q012',  'N00G',   1, 'admin', SYSDATETIME()),
  ('81730-TD000NNB',     N'TRIM ASSY-TAIL GATE SIDE, LH',              'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q012',  'S00B',   1, 'admin', SYSDATETIME()),
  ('81730-TD000PNY',     N'TRIM ASSY-TAIL GATE SIDE, LH',              'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q012',  'S00P',   1, 'admin', SYSDATETIME()),
  ('81740-PI000NNB',     N'TRIM ASSY-TAIL GATE SIDE, RH',              'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q013',  'N00B',   1, 'admin', SYSDATETIME()),
  ('81740-PI000YGN',     N'TRIM ASSY-TAIL GATE SIDE, RH',              'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q013',  'N00G',   1, 'admin', SYSDATETIME()),
  ('81740-TD000NNB',     N'TRIM ASSY-TAIL GATE SIDE, RH',              'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q013',  'S00B',   1, 'admin', SYSDATETIME()),
  ('81740-TD000PNY',     N'TRIM ASSY-TAIL GATE SIDE, RH',              'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q013',  'S00P',   1, 'admin', SYSDATETIME()),
  ('82312-TD000',        N'RAIL-FR DR TRIM UPR, LH (NON DSM)',         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82314-PI000NNB',     N'RAIL-FR DR TRIM UPR, LH(UPR PAINT)',        'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82314-PI000YGU',     N'RAIL-FR DR TRIM UPR, LH(UPR PAINT)',        'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82314-PI010',        N'RAIL-FR DR TRIM UPR, LH(UPR IMG)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82322-TD000',        N'RAIL-FR DR TRIM UPR, RH (NON DSM)',         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82324-PI000NNB',     N'RAIL-FR DR TRIM UPR, RH(UPR PAINT)',        'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82324-PI000YGU',     N'RAIL-FR DR TRIM UPR, RH(UPR PAINT)',        'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82324-PI010',        N'RAIL-FR DR TRIM UPR, RH(UPR IMG)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82330-PI000NNB',     N'PNL-FR DR SIDE TRIM, LH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82330-PI000YGN',     N'PNL-FR DR SIDE TRIM, LH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82330-PI010NNB',     N'PNL-FR DR SIDE TRIM,LH(PLASTIC,OPT)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82330-PI010YGU',     N'PNL-FR DR SIDE TRIM,LH(PLASTIC,OPT)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82334-PI000NNB',     N'GARNISH-FR DR TRIM CTR, LH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82334-PI000YGN',     N'GARNISH-FR DR TRIM CTR, LH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82340-PI000NNB',     N'PNL-FR DR SIDE TRIM, RH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82340-PI000YGN',     N'PNL-FR DR SIDE TRIM, RH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82340-PI010NNB',     N'PNL-FR DR SIDE TRIM, RH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82340-PI010YGU',     N'PNL-FR DR SIDE TRIM, RH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82344-PI000NNB',     N'GARNISH-FR DR TRIM CTR, RH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82344-PI000YGN',     N'GARNISH-FR DR TRIM CTR, RH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82370-PI000NNB',     N'PNL-FR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82370-PI000YGN',     N'PNL-FR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82370-PI000YGU',     N'PNL-FR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82380-PI000NNB',     N'PNL-FR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82380-PI000YGN',     N'PNL-FR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('82380-PI000YGU',     N'PNL-FR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83312-TD100',        N'RAIL-RR DR TRIM UPR, LH (+CURTAIN)',        'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83314-PI100',        N'RAIL-RR DR TRIM UPR, LH(CURTAIN)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83322-TD100',        N'RAIL-RR DR TRIM UPR, RH (+CURTAIN)',        'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83324-PI100',        N'RAIL-RR DR TRIM UPR, RH(CURTAIN)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83330-PI000NNB',     N'PNL-RR DR SIDE TRIM, LH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83330-PI000YGN',     N'PNL-RR DR SIDE TRIM, LH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83330-PI010NNB',     N'PNL-RR DR SIDE TRIM, LH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83330-PI010YGN',     N'PNL-RR DR SIDE TRIM, LH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83330-PI010YGU',     N'PNL-RR DR SIDE TRIM, LH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83334-PI000NNB',     N'GARNISH-RR DR TRIM CTR, LH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83334-PI000YGN',     N'GARNISH-RR DR TRIM CTR, LH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83340-PI000NNB',     N'PNL-RR DR SIDE TRIM, RH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83340-PI000YGN',     N'PNL-RR DR SIDE TRIM, RH(PLASTIC)',          'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83340-PI010NNB',     N'PNL-RR DR SIDE TRIM, RH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83340-PI010YGN',     N'PNL-RR DR SIDE TRIM, RH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83340-PI010YGU',     N'PNL-RR DR SIDE TRIM, RH(PLASTIC,OPT)',      'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83344-PI000NNB',     N'GARNISH-RR DR TRIM CTR, RH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83344-PI000YGN',     N'GARNISH-RR DR TRIM CTR, RH(PLASTIC)',       'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83370-PI000NNB',     N'PNL-RR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83370-PI000YGN',     N'PNL-RR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83370-PI000YGU',     N'PNL-RR DR LWR TRIM, LH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83380-PI000NNB',     N'PNL-RR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83380-PI000YGN',     N'PNL-RR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('83380-PI000YGU',     N'PNL-RR DR LWR TRIM, RH',                    'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85725-PI000NNB',     N'TRIM ASSY-PARTITION LWR',                   'ASSY',     NULL, 'NE1A', 'EA', 0, 'Q100',  'N00B',   1, 'admin', SYSDATETIME()),
  ('85735-TD000NNB',     N'TRIM-LUGG SIDE LWR, LH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85735-TD000ROG',     N'TRIM-LUGG SIDE LWR, LH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85735-TD000YGU',     N'TRIM-LUGG SIDE LWR, LH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85745-TD000NNB',     N'TRIM-LUGG SIDE LWR, RH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85745-TD000ROG',     N'TRIM-LUGG SIDE LWR, RH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85745-TD000YGU',     N'TRIM-LUGG SIDE LWR, RH',                    'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857B5-TD000NNB',     N'BLANKING COVER-WOOFER SPK, RH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857B5-TD000PNY',     N'BLANKING COVER-WOOFER SPK, RH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857E4-TD000NNB',     N'ARMREST COVER CUPHOLDER, RH',               'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857E4-TD000PNY',     N'ARMREST COVER CUPHOLDER, RH',               'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857J1-TD000NNB',     N'ARMREST COVER, LH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857J1-TD000ROG',     N'ARMREST COVER, LH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857J1-TD000YGU',     N'ARMREST COVER, LH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857K1-TD000NNB',     N'ARMREST COVER, RH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857K1-TD000ROG',     N'ARMREST COVER, RH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('857K1-TD000YGU',     N'ARMREST COVER, RH',                         'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('85855-TD000NNB',     N'TRIM ASSY-GATE PILLAR, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q068',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85865-TD000NNB',     N'TRIM ASSY-GATE PILLAR, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q070',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85870-TD000NNB',     N'TRIM ASSY-FRT DR SCUFF, LH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q075',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85870-TD000ROG',     N'TRIM ASSY-FRT DR SCUFF, LH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q075',  'S00D',   1, 'admin', SYSDATETIME()),
  ('85870-TD000YGU',     N'TRIM ASSY-FRT DR SCUFF, LH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q075',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85873-TD000NNB',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85873-TD000YGU',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85873-TD100NNB',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  'SA0B',   1, 'admin', SYSDATETIME()),
  ('85873-TD100ROG',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  'SA0D',   1, 'admin', SYSDATETIME()),
  ('85873-TD100YGU',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  'SA0Y',   1, 'admin', SYSDATETIME()),
  ('85873-TD2004NB',     N'TRIM ASSY-FRT DR STEP, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q071',  NULL,     1, 'admin', SYSDATETIME()),
  ('85875-TD000NNB',     N'TRIM ASSY-RR DR SCUFF, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q077',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85875-TD000ROG',     N'TRIM ASSY-RR DR SCUFF, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q077',  'S00D',   1, 'admin', SYSDATETIME()),
  ('85875-TD000YGU',     N'TRIM ASSY-RR DR SCUFF, LH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q077',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85877-TD000NNB',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85877-TD000YGU',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85877-TD100NNB',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  'SA0B',   1, 'admin', SYSDATETIME()),
  ('85877-TD100ROG',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  'SA0D',   1, 'admin', SYSDATETIME()),
  ('85877-TD100YGU',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  'SA0Y',   1, 'admin', SYSDATETIME()),
  ('85877-TD2004NB',     N'TRIM ASSY-RR DR STEP, LH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q073',  NULL,     1, 'admin', SYSDATETIME()),
  ('85880-TD000NNB',     N'TRIM ASSY-FRT DR SCUFF, RH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q076',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85880-TD000ROG',     N'TRIM ASSY-FRT DR SCUFF, RH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q076',  'S00D',   1, 'admin', SYSDATETIME()),
  ('85880-TD000YGU',     N'TRIM ASSY-FRT DR SCUFF, RH',                'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q076',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85883-TD000NNB',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85883-TD000YGU',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85883-TD100NNB',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  'SA0B',   1, 'admin', SYSDATETIME()),
  ('85883-TD100ROG',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  'SA0D',   1, 'admin', SYSDATETIME()),
  ('85883-TD100YGU',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  'SA0Y',   1, 'admin', SYSDATETIME()),
  ('85883-TD2004NB',     N'TRIM ASSY-FRT DR STEP, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q072',  NULL,     1, 'admin', SYSDATETIME()),
  ('85885-TD000NNB',     N'TRIM ASSY-RR DR SCUFF, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q078',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85885-TD000ROG',     N'TRIM ASSY-RR DR SCUFF, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q078',  'S00D',   1, 'admin', SYSDATETIME()),
  ('85885-TD000YGU',     N'TRIM ASSY-RR DR SCUFF, RH',                 'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q078',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85887-TD000NNB',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  'S00B',   1, 'admin', SYSDATETIME()),
  ('85887-TD000YGU',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  'S00Y',   1, 'admin', SYSDATETIME()),
  ('85887-TD100NNB',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  'SA0B',   1, 'admin', SYSDATETIME()),
  ('85887-TD100ROG',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  'SA0D',   1, 'admin', SYSDATETIME()),
  ('85887-TD100YGU',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  'SA0Y',   1, 'admin', SYSDATETIME()),
  ('85887-TD2004NB',     N'TRIM ASSY-RR DR STEP, RH',                  'ASSY',     NULL, 'ME1A', 'EA', 0, 'Q074',  NULL,     1, 'admin', SYSDATETIME()),
  ('M1211-PI000NNB',     N'MODULE ASSY-FR DR SIDE TRIM, LH(PLASTIC,',  'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1221-PI000NNB',     N'MODULE ASSY-FR DR SIDE TRIM, RH(PLASTIC,',  'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1610-PI000NNB',     N'MODULE ASSY-FR PULL HDL, LH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1610-PI000YGU',     N'MODULE ASSY-FR PULL HDL, LH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1620-PI000NNB',     N'MODULE ASSY-FR PULL HDL, RH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1620-PI000YGU',     N'MODULE ASSY-FR PULL HDL, RH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1630-PI000NNB',     N'MODULE ASSY-RR PULL HDL, LH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1630-PI000YGU',     N'MODULE ASSY-RR PULL HDL, LH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1630-PI010NNB',     N'MODULE ASSY-RR PULL HDL, LH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1640-PI000NNB',     N'MODULE ASSY-RR PULL HDL, RH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1640-PI000YGU',     N'MODULE ASSY-RR PULL HDL, RH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M1640-PI010NNB',     N'MODULE ASSY-RR PULL HDL, RH',               'MATERIAL', NULL, 'NE1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57B4-TD000NNB',     N'MODULE ASSY-WOOFER SPK, RH',                'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57B4-TD000PNY',     N'MODULE ASSY-WOOFER SPK, RH',                'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57J1-TD000NNB',     N'MODULE ASSY-ARMREST COVER, LH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57J1-TD000ROG',     N'MODULE ASSY-ARMREST COVER, LH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57J1-TD000YGU',     N'MODULE ASSY-ARMREST COVER, LH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57K1-TD000NNB',     N'MODULE ASSY-ARMREST COVER, RH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57K1-TD000ROG',     N'MODULE ASSY-ARMREST COVER, RH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME()),
  ('M57K1-TD000YGU',     N'MODULE ASSY-ARMREST COVER, RH',             'MATERIAL', NULL, 'ME1A', 'EA', 0, NULL,    NULL,     1, 'admin', SYSDATETIME());
-- 사출 원료(레진) — 파트마스터에는 없지만 MD_MoldItem.ResinItemNo 가 참조한다(6행).
INSERT INTO dbo.MD_Item (ItemNo, ItemName, ItemNameEN, ItemType, ItemCategory, DefaultUOM, ActiveFlag, CreatedBy, CreatedTS) VALUES
  ('RESIN-PP-TD20BK',    N'PP+TD20 RESIN PELLET, BLACK',     N'PP+TD20 RESIN PELLET, BLACK',     'MATERIAL', 'RESIN', 'KG', 1, 'admin', SYSDATETIME()),
  ('RESIN-PP-TD20NB',    N'PP+TD20 RESIN PELLET, NAT BEIGE', N'PP+TD20 RESIN PELLET, NAT BEIGE', 'MATERIAL', 'RESIN', 'KG', 1, 'admin', SYSDATETIME());
COMMIT;
