...
SELECT COUNT(*) AS MenuRows    FROM dbo.MD_Menu;
SELECT COUNT(*) AS RoleRows    FROM dbo.MD_MenuRole;
SELECT MenuCode, MenuName, MenuNameEn FROM dbo.MD_Menu ORDER BY SectionCode, SortOrder;
GO
