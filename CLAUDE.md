...
- 데모에만 있고 소스에 없는 대표 기능: MNT-02 수리 완료(근본 원인·조치·완료 시각), MNT-07 작업지시 발행/배정/완료 모달, MNT-04 Shot 갱신·금형 정비 등록, MNT-08 입고(Receive Stock), PP-05 MRP 실행, SYS-06 알림 테스트 발송. 소스에만 있는 것: MNT-010 보전 PM, SYS 역할·화면 레지스트리, MD 스테이션·위치·라우팅·현장 작업자, WH/FG 웹 화면.
